...
const RefundedRequests = () => {
  ...
  const refundedRequests = [
    ...
    },
    {
      ...
      orderId: 100095,
      productInfo: {
        name: "Straps Plaid Patchwork Dress",
        qty: 1,
        image: "/dress.png"
      },
      customerInfo: {
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-4 md:p-6 lg:p-8">
          ...
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-xl font-semibold text-gray-800">Refunded Refund Requests</h1>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 mr-3">
                          <img src={request.productInfo.image} alt="Product" className="h-10 w-10 object-cover" />
                        </div>
                        <div>
...
export default RefundedRequests;