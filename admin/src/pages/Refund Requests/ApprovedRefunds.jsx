          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-4 border-b">
              <div className="flex items-center">
                <div className="flex items-center text-gray-700">
                  ...
                  <h2 className="ml-2 text-lg font-semibold">Approved Refund Requests</h2>
                  <span className="ml-2 px-2 py-1 text-xs font-medium bg-gray-200 rounded-full">2</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex items-center gap-2 self-end">
                <button className="flex items-center space-x-2 px-4 py-2 border border-gray-300 rounded text-gray-700 bg-white hover:bg-gray-50">
                ...
                <select
                  className="px-4 py-2 border border-gray-300 rounded text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  value={filterOption}
                  ...
                  {approvedRefunds.map((refund) => (
                    <tr key={refund.refundId} className="hover:bg-gray-50">
                        ...
                        <div className="flex items-center">
                          {refund.product.image ? (
                            <div className="flex-shrink-0 h-10 w-10">
                              <img className="h-10 w-10 rounded-full object-cover" src={refund.product.image} alt="" />
                            </div>
                          ) : null}
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">{refund.product.name}</div>
                            {refund.product.qty > 0 && (
                              <div className="text-sm text-gray-500">QTY : {refund.product.qty}</div>
                            )}
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500">{refund.customer.phone}</div>
                      </td>
