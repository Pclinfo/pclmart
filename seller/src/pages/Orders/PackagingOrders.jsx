        ...
        <div className="flex-1 p-4">
          ...
          <div className="flex items-center mb-6">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-gray-800">Packaging Orders</h1>
              <span className="ml-2 bg-blue-600 text-white px-2 py-0.5 rounded-md text-sm">9</span>
            </div>
          </div>
